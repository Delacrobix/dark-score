...
export function SplitView() {
  ...
  const { pages, currentPage } = useAppStore()
  ...
  return (
    <div className="w-full flex flex-col gap-2">
      ...
      <div
        ref={containerRef}
        className="relative w-full overflow-hidden rounded-lg border border-zinc-800 select-none"
        style={{ aspectRatio: `${page.originalImageData.width} / ${page.originalImageData.height}` }}
      >
        {/* Original (full width, clipped to left portion) */}
        <canvas
        ...
        {/* Processed (full width, clipped to right portion) */}
        <canvas
