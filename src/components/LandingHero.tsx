...
export function LandingHero({ onGetStarted }: LandingHeroProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center bg-black">
      <div className="mb-6 select-none text-7xl" role="img" aria-label="Clave de sol">
        𝄞
      </div>
      ...
      <p className="text-lg text-zinc-400 mb-6 max-w-xs">
        Convierte tus partituras a modo oscuro
      </p>

      <p className="text-sm text-zinc-600 max-w-lg leading-relaxed mb-10">
        Leer partituras en pantalla de noche, o en un escenario oscuro, con el
        fondo blanco tradicional es agotador para la vista. Dark Score invierte
        los colores de tus PDFs e imágenes de forma inteligente: elimina el
        ruido del escaneo, engrosa las líneas del pentagrama y aplica el
        esquema de color que prefieras.
      </p>
      ...
      <div className="mt-10 max-w-md border border-zinc-900 rounded-xl px-6 py-5 text-left">
        ...
        <p className="text-xs text-zinc-600 leading-relaxed">
          Entendemos que tus partituras son importantes para ti. Por ese motivo, esta web
          no copia ni envía tus archivos a ningún servidor externo. Todo el procesamiento
          ocurre directamente en tu navegador, sin conexiones externas.
        </p>
        <a
          href="https://github.com/Delacrobix/dark-score"
          target="_blank"
          rel="noopener noreferrer"
          className="mt-3 inline-flex items-center gap-1.5 text-xs text-zinc-600 hover:text-zinc-400 transition-colors"
        >
